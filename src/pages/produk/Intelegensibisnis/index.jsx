...
export default function IntelegensiBisnis() {
            ...
            {isDesktop ?
                <Box bg={"#F5FAFF"} >
                    <HStack w={'90%'} mx={'auto'} py={{ base: 0, lg: '30px' }}>
                        <Box>
                            <Heading color={'blue'} mb={'20px'}>Intelegensi Bisnis</Heading>
                            <Heading mb={'30px'}>Analisis data komprehensif buat keputusan bisnis tepat</Heading>
                            <Text mb={'30px'} >Jalankan bisnismu lebih terarah dan tidak salah langkah.</Text>
                            <Button w={'150px'} h={'60px'} color={'white'} bg={'blue'} >Coba Gratis</Button>
                        </Box>
                        <Center>
                            <Image w={'1000px'} h={'600px'} src={"https://jubelio.com/wp-content/uploads/2023/05/cover-inteligensi-bisnis-1-1536x1536.png"} />
                        </Center>
                ...
                <Box bg={"#F5FAFF"} >
                    <Box w={'90%'} mx={'auto'}>
                        <Center>
                            <Image w={'350px'} h={'300px'} src={"https://jubelio.com/wp-content/uploads/2023/05/cover-inteligensi-bisnis-1-1536x1536.png"} />
                        </Center>
                        <Box pb={'50px'}>
                            <Heading color={'blue'} mb={'20px'}>Intelegensi Bisnis</Heading>
                            <Heading mb={'30px'}>Analisis data komprehensif buat keputusan bisnis tepat</Heading>
